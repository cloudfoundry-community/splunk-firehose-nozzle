...
func easyjson633f8c25DecodeGithubComCloudfoundryCommunitySplunkFirehoseNozzleCaching(in *jlexer.Lexer, out *App) {
	if in.IsNull() {
		in.Skip()
		return
	}
...
func easyjson633f8c25EncodeGithubComCloudfoundryCommunitySplunkFirehoseNozzleCaching(out *jwriter.Writer, in App) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v App) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson633f8c25EncodeGithubComCloudfoundryCommunitySplunkFirehoseNozzleCaching(&w, v)
...
func (v *App) UnmarshalJSON(data []byte) error {
	...
	easyjson633f8c25DecodeGithubComCloudfoundryCommunitySplunkFirehoseNozzleCaching(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *App) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson633f8c25DecodeGithubComCloudfoundryCommunitySplunkFirehoseNozzleCaching(l, v)
}
