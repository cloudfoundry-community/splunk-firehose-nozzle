...
var _ = Describe("Http", func() {
	It("inserts an auth header for any calls it makes", func() {
		...
		c := eventsource.NewHttp(tf, "test-client", "test-secret", true)
...
func (s *stubTokenFetcher) GetAuthToken(clientId, clientSecret string, skipCertVerify bool) (string, error) {
